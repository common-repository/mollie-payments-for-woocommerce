...
class Voucher extends \Mollie\WooCommerce\PaymentMethods\AbstractPaymentMethod implements \Mollie\WooCommerce\PaymentMethods\PaymentMethodI
{
    ...
    {
        return ['id' => 'voucher', 'defaultTitle' => __('Voucher', 'mollie-payments-for-woocommerce'), 'settingsDescription' => '', 'defaultDescription' => '', 'paymentFields' => \false, 'instructions' => \false, 'supports' => ['products'], 'filtersOnBuild' => \false, 'confirmationDelayed' => \false, 'SEPA' => \false, 'orderMandatory' => \true];
    }
    ...
    public function voucherDefaultCategory(): string
    {
        ...
        return $mealvoucherSettings ? $mealvoucherSettings['mealvoucher_category_default'] : \Mollie\WooCommerce\PaymentMethods\Voucher::NO_CATEGORY;
    }
}
