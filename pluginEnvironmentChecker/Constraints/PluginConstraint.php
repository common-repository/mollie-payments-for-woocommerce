...
class PluginConstraint extends AbstractVersionConstraint
{
    ...
    public function check()
    {
        ...
        if (!$isPluginActive) {
            $this->message = "The {$this->pluginDisplayName} plugin must be active. Please install & activate {$this->pluginDisplayName}";
            // phpcs:disable WordPress.Security.EscapeOutput.ExceptionNotEscaped
            throw new ConstraintFailedException($this, esc_html($this->requiredPluginName), [$this->error], esc_html($this->message));
